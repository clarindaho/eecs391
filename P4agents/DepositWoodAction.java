...
public class DepositWoodAction implements StripsAction {
	//instance fields
	Position townHallPosition = null;
	...
	public DepositWoodAction(UnitView peasant, Position newPosition, Position townHallPosition, GameState parent) {
	...
	public boolean preconditionsMet(GameState state) {
		...
		if (hasWood() && newPosition.equals(townHallPosition)) {
			return true;
		}
		return false;
	}

	// checks if the peasant is holding wood
